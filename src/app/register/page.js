    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary-50 to-primary-100 dark:from-gray-900 dark:to-gray-800 px-3 sm:px-4 py-6 sm:py-8">
      <Card className="w-full max-w-md">
        ...
        <div className="text-center mb-6 sm:mb-8">
          <h2 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-gray-100 mb-1 sm:mb-2">Create Account</h2>
          <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">Sign up to get started</p>
        </div>

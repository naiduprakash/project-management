...
const Button = ({ 
  ...
  const variants = {
    ...
    danger: 'bg-white text-red-600 hover:bg-red-50 focus:ring-red-500 border-2 border-red-200',
    ghost: 'text-gray-700 hover:bg-gray-100 focus:ring-gray-400',
    success: 'bg-primary-500 text-white hover:bg-primary-600 focus:ring-primary-400 shadow-sm'
  }
